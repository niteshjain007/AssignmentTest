...
public class GeneralUtility {
    ...
    public void scrollTillElementView(WebDriver driver, WebElement elm) {
    ...
    public void explicatWaitTillInvisibility(WebDriver driver, WebElement elm) {
        WebDriverWait wait2 = new WebDriverWait(driver, Duration.ofSeconds(30));
        wait2.until(ExpectedConditions.invisibilityOf(elm));
